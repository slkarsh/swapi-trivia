...
const SelectedMovie = ({ movie, characters, addFavorite, removeFavorite }) => {
  return (
    <main className='selected-movie'>
      ...
      {!characters.length
        ? <img
          ...
          alt="" />
        : <CharactersContainer characters={characters} addFavorite={addFavorite} removeFavorite={removeFavorite} />}
    </main>
  )
}
